...
import type { EntityFilter, EntityIdFields, EntityMetadata, EntityOrderBy, EntityRef, FieldsMetadata, LifecycleEvent, MembersOnly } from './remult3/remult3.js';
...
export interface EntityOptions<entityType = unknown> {
     ...
     */
    id?: keyof MembersOnly<entityType> | (keyof MembersOnly<entityType>)[] | EntityIdFields<entityType> | ((entity: FieldsMetadata<entityType>) => FieldMetadata | FieldMetadata[]);
     ...
     */
    dataProvider?: (defaultDataProvider: DataProvider) => DataProvider | Promise<DataProvider> | undefined | null;
}
/**
