...
var ActualSQLEntityDataProvider = /** @class */ (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        e = _g.sent();
                        _a = this.buildSelect(e, options === null || options === void 0 ? void 0 : options.select), colKeys = _a.colKeys, select = _a.select;
    ...
    ActualSQLEntityDataProvider.prototype.buildSelect = function (e, selectedFields) {
        var e_4, _a;
        var select = '';
        var colKeys = [];
