...
var KnexEntityDataProvider = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1: return [2 /*return*/, _a.apply(void 0, _b.concat([_c.sent(), this.dp.createCommand(),
                            false,
                            function (limit, offset) { return ' limit ' + limit + ' offset ' + offset; }]))];
                }
            });
        });
    };
    ...
    KnexEntityDataProvider.prototype.find = function (options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e, cols, colKeys, joins, _a, _b, x, name_1, jm, err_2, e_3_1, query, _loop_1, joins_1, joins_1_1, j, br, r_1, r;
            var e_3, _c, e_4, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 4:
                        ...
                        colKeys.push(x);
                        if (!(x.options && x.options.joinMetadata)) return [3 /*break*/, 8];
                        _e.label = 5;
                    case 5:
                        _e.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, x.options.joinMetadata(this.entity)];
                    case 6:
                        jm = _e.sent();
                        if (jm && jm.alias && jm.table && jm.id && jm.fk) {
                            joins.push(jm);
                        }
                        return [3 /*break*/, 8];
                    case 7:
                    ...
                    case 12:
                        ...
                        _loop_1 = function (j) {
                            ...
                            query = query.leftJoin((_f = {}, _f[j.alias] = j.table, _f), function (join) {
                                join.on("".concat(j.alias, ".").concat(j.id), '=', j.fk);
                            });
                        };
                        try {
                            for (joins_1 = tslib_1.__values(joins), joins_1_1 = joins_1.next(); !joins_1_1.done; joins_1_1 = joins_1.next()) {
                                j = joins_1_1.value;
                                _loop_1(j);
                            }
                        }
                            ...
                            try {
                                if (joins_1_1 && !joins_1_1.done && (_d = joins_1.return)) _d.call(joins_1);
                            }
                            finally { if (e_4) throw e_4.error; }
                        }
                        if (!(options === null || options === void 0 ? void 0 : options.where)) return [3 /*break*/, 14];
                        br = new FilterConsumerBridgeToKnexRequest(e, this.rawSqlWrapIdentifier);
    ...
    KnexEntityDataProvider.prototype.init = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var r, entityName, entityAlias;
            var _this = this;
            var _a, _b;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, (0, filter_consumer_bridge_to_sql_request_js_1.dbNamesOfWithForceSqlExpression)(this.entity, {
                            wrapIdentifier: function (x) { return x; },
                            tableName: true,
                        })];
                    case 1:
                        r = (_c.sent());
                        entityName = ((_b = (_a = r.$entityName) === null || _a === void 0 ? void 0 : _a.toString) === null || _b === void 0 ? void 0 : _b.call(_a)) || r.$entityName;
                        entityAlias = this.entity.options.sqlExpression
                            ? entityName.trim().split(/\s+/).pop()
                            : undefined;
                        return [2 /*return*/, {
                                $dbNameOf: function (f) {
                                    var fm = f;
                                    ...
                                    var base = r.$dbNameOf(f);
                                    if (entityAlias) {
                                        var parts = base.split('.');
                                        var col = parts[parts.length - 1];
                                        return "".concat(entityAlias, ".").concat(col);
                                    }
                                    return base;
                                },
    ...
    KnexEntityDataProvider.prototype.update = function (id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e, f, updateObject, _a, _b, x, v, key, e_5_1, where;
            var e_5, _c;
    ...
    KnexEntityDataProvider.prototype.insert = function (data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e, insertObject, _a, _b, x, v, key, e_6_1, insert, newId_1, result, result;
            var e_6, _c;
            var _this = this;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
...
var FilterConsumerBridgeToKnexRequest = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        p_1 = (e_7 = void 0, tslib_1.__values(p)), p_1_1 = p_1.next();
                        _b.label = 2;
                    case 2:
    ...
    FilterConsumerBridgeToKnexRequest.prototype.or = function (orElements) {
        ...
        this.promises.push((function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var result, _loop_2, this_1, orElements_1, orElements_1_1, element, state_1, e_8_1;
            var e_8, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
...
var KnexSchemaBuilder = /** @class */ (function () {
    ...
    KnexSchemaBuilder.prototype.ensureSchema = function (entities) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var entities_1, entities_1_1, entity, e, err_3, e_9_1;
            var e_9, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 7:
                        err_3 = _b.sent();
                        console.error('failed ensure schema of ' + e.$entityName + ' ', err_3);
                        throw err_3;
                    case 8:
    ...
    KnexSchemaBuilder.prototype.verifyAllColumns = function (entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e, _loop_3, this_2, _a, _b, col, e_12_1, err_4;
            var e_12, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, (0, filter_consumer_bridge_to_sql_request_js_2.dbNamesOf)(entity, function (x) { return x; })];
